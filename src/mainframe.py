...
class MainFrame(wx.Frame):
    ...
    def __init__(
        ...
        # Use ArtProvider since images are missing
        self._bitmaps: dict[str, wx.Bitmap] = {
            "down": wx.ArtProvider.GetBitmap(wx.ART_GO_DOWN, wx.ART_BUTTON, (32, 32)),
            "up": wx.ArtProvider.GetBitmap(wx.ART_GO_UP, wx.ART_BUTTON, (32, 32)),
            "play": wx.ArtProvider.GetBitmap(wx.ART_EXECUTABLE_FILE, wx.ART_BUTTON, (32, 32)),
            "start": wx.ArtProvider.GetBitmap(wx.ART_GO_FORWARD, wx.ART_BUTTON, (32, 32)),
            "delete": wx.ArtProvider.GetBitmap(wx.ART_DELETE, wx.ART_BUTTON, (32, 32)),
            "folder": wx.ArtProvider.GetBitmap(wx.ART_FILE_OPEN, wx.ART_BUTTON, (32, 32)),
            "pause": wx.ArtProvider.GetBitmap(wx.ART_WARNING, wx.ART_BUTTON, (32, 32)),
            "resume": wx.ArtProvider.GetBitmap(wx.ART_GO_FORWARD, wx.ART_BUTTON, (32, 32)),
            "reload": wx.ArtProvider.GetBitmap(wx.ART_REDO, wx.ART_BUTTON, (32, 32)),
            "settings": wx.ArtProvider.GetBitmap(wx.ART_HELP, wx.ART_BUTTON, (20, 20)),
            "stop": wx.ArtProvider.GetBitmap(wx.ART_QUIT, wx.ART_BUTTON, (32, 32)),
        }
