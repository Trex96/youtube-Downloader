...
class ExtraTab(TabPanel):
    ...
    BROWSERS: list[str] = ["brave", "chrome", "chromium", "edge", "firefox", "opera", "safari", "vivaldi"]
    ...
    def __init__(self, *args, **kwargs):
        ...
        self.cookies_opts_label = self.crt_statictext(_("Authentication Options"))
        self.enable_cookies_checkbox = self.crt_checkbox(_("Import cookies from browser"))
        self.cookies_browser_combobox = self.crt_combobox(self.BROWSERS)
    ...
    def _set_layout(self) -> None:
        ...
        vertical_sizer.Add(self.cookies_opts_label, flag=wx.TOP, border=5)
        cookies_sizer = wx.BoxSizer(wx.HORIZONTAL)
        cookies_sizer.Add(self.enable_cookies_checkbox, flag=wx.ALIGN_CENTER_VERTICAL)
        cookies_sizer.AddSpacer(5)
        cookies_sizer.Add(self.cookies_browser_combobox, flag=wx.ALIGN_CENTER_VERTICAL)
        vertical_sizer.Add(cookies_sizer, flag=wx.ALL, border=5)
    ...
    def load_options(self) -> None:
        ...
        self.enable_cookies_checkbox.SetValue(self.opt_manager.options.get("enable_cookies", False))
        self.cookies_browser_combobox.SetValue(self.opt_manager.options.get("cookies_browser", "chrome"))
    ...
    def save_options(self) -> None:
        ...
        self.opt_manager.options["enable_cookies"] = self.enable_cookies_checkbox.GetValue()
        self.opt_manager.options["cookies_browser"] = self.cookies_browser_combobox.GetValue()
